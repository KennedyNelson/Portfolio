  ...
  return (
    <div className='group relative flex cursor-pointer'>
        <motion.img
            ...
            className='rounded-full border border-gray-500 object-cover w-20 h-20 md:w-24 md:h-24 xl:w-32 xl:h-32 filter group-hover:grayscale transition duration-300 ease-in-out'
        />
